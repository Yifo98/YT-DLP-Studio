// Generated from https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md
// Used only for local cookie-source matching in the MediaCookies extension.
export const YT_DLP_SUPPORTED_SITE_NAMES = [
  "10play",
  "10play:season",
  "17live",
  "17live:clip",
