...
- Windows：优先下载 `YT-DLP Studio-2.0.0-win.zip`
- macOS：优先下载 `YT-DLP Studio-2.0.0-arm64-mac.zip`
...
- [2.0.0 发布文案](docs/release-2.0.0.md)
...
- Windows: prefer `YT-DLP Studio-2.0.0-win.zip`, or use the portable `YT-DLP Studio 2.0.0.exe`
- macOS: prefer `YT-DLP Studio-2.0.0-arm64-mac.zip`
...
- [2.0.0 Release Copy](docs/release-2.0.0.md)
